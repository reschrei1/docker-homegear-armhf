...
RUN apt-get update && \
    ...
    apt-get update && \
    apt-get -y install homegear homegear-homematicbidcos homegear-enocean homegear-intertechno homegear-homematicwired homegear-insteon homegear-max homegear-philipshue homegear-sonos homegear-kodi homegear-ipcam homegear-beckhoff homegear-knx && \
    apt-get clean && \
